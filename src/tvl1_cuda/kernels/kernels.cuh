...
constexpr float FLT_MAX{65504.0};
...
__global__ void bicubicResample(const __half2* Is, __half2 *Iout, const int* nxx, const int* nyy, const int* nx, const int* ny, float factor);
...
__global__ void estimateThreshold(const __half2* rho_c, const __half2* I1wx, const __half2* u1, const __half2* I1wy, const __half2* u2, const __half2* grad, float llT, size_t size, __half2* v1, __half2* v2);
__global__ void estimateOpticalFlow(__half2* u1, __half2* u2, const __half2* v1, const __half2* v2, const __half2* div_p1, const __half2* div_p2, float theta, size_t size, float* error);
__global__ void estimateGArgs(const __half2* div_p1, const __half2* div_p2, const __half2* v1, const __half2* v2, size_t size, float taut, __half2* g1, __half2* g2);
